...
class SearchListWidget extends StatefulWidget {
  ...
  const SearchListWidget({super.key, required this.keyword});

  @override
  State<SearchListWidget> createState() => SearchListWidgetState();
}
...
class SearchListWidgetState extends State<SearchListWidget> {
  ...
  void _loadTasks() {
    setState(() {
      _futureTasks = TaskService.searchTasksKeyword(widget.keyword);
    });
  }
